#!/usr/bin/python3
#
# A Program to Handle Text Input from the User
#    texthandler.py
#
...
# Lesson 7 - Exercise 2
"""
Demonstrates use of tkinter module to take user input
and convert it based upon the selection the user makes.
"""
...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.handleb = Button(bottom_frame, 
                              text="Convert", 
                              command=self.handle).pack(side=LEFT)
        self.QUIT = Button(bottom_frame, 
                           text="Quit", 
